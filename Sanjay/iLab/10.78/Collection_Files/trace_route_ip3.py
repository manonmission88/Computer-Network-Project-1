    ...
    for i in range(1, 28):
        ...
        try:
            ...
            if reply is None:
                ...
                with open("location_ilab3.txt","a") as f:
                ...
                with open("location_ilab3.txt","a") as f: # change the txt files accordingly 
...
def main():
    for i in range(75, 100):
        for j in range(1,256): # can skip by 16 
            with open("location_ilab3.txt","a") as f:
                    f.write(f"For traceroute: 10.78.{i}.{j}\n")
            trace_route(f"10.78.{i}.{j}")  
