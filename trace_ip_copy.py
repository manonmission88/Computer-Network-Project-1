...
ipaddr = "10.77.96.1"  # private ip # possible ips to ping  # 138.238.3.33  # 10.26.96.1 # 66.44.94.195
    ...
    for i in range(1, 28):
        ...
        try:
            ...
            if reply is None:
                ...
                with open("stokes_library_1.txt","a") as f:
                ...
                with open("stokes_library_1.txt","a") as f: # change the txt files accordingly 
...
def main():
    for i in range(2,256):
        for j in range(1,256,4): # can skip by 16
            with open("stokes_library_1.txt","a") as f:
                    f.write(f"For ip address 10.77.{i}.{j} \n")
            trace_route(f"10.77.{i}.{j}")      # change ipaddr prefix accordingly
main()
