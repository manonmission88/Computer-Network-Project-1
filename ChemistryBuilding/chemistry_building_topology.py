...
routers = parse_traceroute_file('ChemistryBuilding/chemistry_building_10.199.txt')
...
image_path = "ChemistryBuilding/chemistry_building_10.199.png"
plt.savefig(image_path)
plt.close()

# Write the image reference to a Markdown file
with open("ChemistryBuilding/chemistry_building_10.199.md", "w") as md_file:
